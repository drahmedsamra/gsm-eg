  ...
  const schema = [
    {
      ...
      description:
        "أكاديمية GSM الدولية متخصصة في تدريب صيانة الموبايل والإلكترونيات والبرمجة والروبوتات وبرنامج المخترع الصغير، وتقدم دورات احترافية تؤهل لسوق العمل.",
...

    {
      ...
      description:
        "الموقع الرسمي لأكاديمية GSM الدولية للتدريب.",
